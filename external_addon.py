...
addon_folder = 'blender-git-integration'

source_path = "\\\\wsl$\\Ubuntu\\home\\nameless\\documents\\blender\\"
...
files = glob.glob(os.path.join(addon_path, files_mask)) + \
    [os.path.join(addon_path, file) for file in add_files_names]
